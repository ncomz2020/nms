...
public class User extends Paging {
	...
	public String getSrt_no_en() {
		return srt_no_en;
	}
	public void setSrt_no_en(String srt_no_en) {
		this.srt_no_en = srt_no_en;
	}
	...
	public String getTeam_cd_en() {
		return team_cd_en;
	}
	public void setTeam_cd_en(String team_cd_en) {
		this.team_cd_en = team_cd_en;
	}
	...
	public String getRank_cd_en() {
		return rank_cd_en;
	}
	public void setRank_cd_en(String rank_cd_en) {
		this.rank_cd_en = rank_cd_en;
	}
	...
	public String getPsit_cd_en() {
		return psit_cd_en;
	}
	public void setPsit_cd_en(String psit_cd_en) {
		this.psit_cd_en = psit_cd_en;
	}
	...
	public String getStep_cd_en() {
		return step_cd_en;
	}
	public void setStep_cd_en(String step_cd_en) {
		this.step_cd_en = step_cd_en;
	}
	...
	public String toString() {
		return "User [cre_dt_st=" + cre_dt_st + ", emp_no=" + emp_no + ", usr_nm=" + usr_nm + ", usr_grp_id="
				+ usr_grp_id + ", search_usr_grp_id=" + search_usr_grp_id + ", srt_no=" + srt_no + ", srt_no_en="
				+ srt_no_en + ", gend_cd=" + gend_cd + ", addr=" + addr + ", tel_no=" + tel_no + ", expln=" + expln
				+ ", expln_en=" + expln_en + ", cre_dt=" + cre_dt + ", career_period=" + career_period + ", rownum="
				+ rownum + ", file_id=" + file_id + ", phy_file_nm=" + phy_file_nm + ", ori_file_nm=" + ori_file_nm
				+ ", file_uri=" + file_uri + ", cell_no=" + cell_no + ", fax_no=" + fax_no + ", email=" + email
				+ ", mari_yn=" + mari_yn + ", spe_abil=" + spe_abil + ", mil_cd=" + mil_cd + ", mil_strt_dt="
				+ mil_strt_dt + ", mil_end_dt=" + mil_end_dt + ", dept_cd=" + dept_cd + ", dept_cd_en=" + dept_cd_en
				+ ", team_cd=" + team_cd + ", team_cd_en=" + team_cd_en + ", rank_cd=" + rank_cd + ", rank_cd_en="
				+ rank_cd_en + ", psit_cd=" + psit_cd + ", psit_cd_en=" + psit_cd_en + ", step_cd=" + step_cd
				+ ", step_cd_en=" + step_cd_en + ", com_cd=" + com_cd + ", com_strt_dt=" + com_strt_dt + ", worp_cd="
				+ worp_cd + ", grade=" + grade + ", upd_dt=" + upd_dt + ", dept_cd_st=" + dept_cd_st + ", team_cd_st="
				+ team_cd_st + ", rank_cd_st=" + rank_cd_st + ", psit_cd_st=" + psit_cd_st + ", step_cd_st="
				+ step_cd_st + ", grade_st=" + grade_st + ", search_date_type=" + search_date_type + ", month_period="
				+ month_period + ", search_month=" + search_month + ", edu_seq=" + edu_seq + ", schl_nm=" + schl_nm
				+ ", edu_strt_dt=" + edu_strt_dt + ", edu_end_dt=" + edu_end_dt + ", major=" + major + ", edu_remark="
				+ edu_remark + ", cert_seq=" + cert_seq + ", cert_nm=" + cert_nm + ", get_dt=" + get_dt
				+ ", cert_remark=" + cert_remark + ", carr_seq=" + carr_seq + ", carr_com_nm=" + carr_com_nm
				+ ", carr_strt_dt=" + carr_strt_dt + ", carr_end_dt=" + carr_end_dt + ", carr_rank_nm=" + carr_rank_nm
				+ ", work=" + work + ", task_seq=" + task_seq + ", prjt_nm=" + prjt_nm + ", rltd_com=" + rltd_com
				+ ", dev_strt_dt=" + dev_strt_dt + ", dev_end_dt=" + dev_end_dt + ", my_role=" + my_role
				+ ", used_mdel=" + used_mdel + ", used_os=" + used_os + ", used_lang=" + used_lang + ", used_dbms="
				+ used_dbms + ", used_dc=" + used_dc + ", cre_id=" + cre_id + ", upd_id=" + upd_id + ", pwd_asis="
				+ pwd_asis + ", pwd_tobe=" + pwd_tobe + "]";
	}
