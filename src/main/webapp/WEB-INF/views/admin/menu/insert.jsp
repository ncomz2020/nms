...
<script>
	$(document).ready(function() {
		$("#iconList i").click(function() {
			...
			$("#insert_icon").val($(this).attr("class"));
		});
	});
...
<div class="modal-content">
	<h1 class="popupHeader">
		<span class="title"><spring:message code="label.menu.add"/></span>
		...
		<div class="rowBox">
			<div class="unitBox" style="">
				<form id="insertForm" action="javascript:insertAction();">
					<input type="hidden" name="parent_id" value="${parent.menu_id}">
					<input type="hidden" id="insert_icon" name="icon">
					<table class="amb_form_table lineAll">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<input type="text" class="inp" style="width: 100%;" id="insert_url" name="url" placeholder="URL" maxlength="50" value="<c:out value="${menu.url}"/>" onfocus="this.value = this.value;">
								</td>
							</tr>
							<!-- <tr>
							...
							<tr>
								...
								<td>
									<input type="checkbox" id="chk_admin" name="chk_admin" onclick="return false;" checked >
									<label for="chk_admin" class="inp_func">관리자</label>
									&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="checkbox" id="chk_dept" name="chk_dept">
									<label for="chk_dept" class="inp_func">사업부장</label>
									&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="checkbox" id="chk_team" name="chk_team" >
									<label for="chk_team" class="inp_func">팀장</label>
									&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="checkbox" id="chk_user" name="chk_user" >
									<label for="chk_user" class="inp_func">사용자</label>
								</td>
							</tr>
						</tbody>
					</table>
