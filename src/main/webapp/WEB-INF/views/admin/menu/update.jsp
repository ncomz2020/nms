						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<label for="chk_admin" class="inp_func"><spring:message code="label.menu.admin"/></label>
									&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="checkbox" id="chk_dept" name="chk_dept" <c:if test="${menu.chk_dept}">checked</c:if>>
									<label for="chk_dept" class="inp_func"><spring:message code="label.menu.dept"/></label>
									&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="checkbox" id="chk_team" name="chk_team" <c:if test="${menu.chk_team}">checked</c:if>>
									<label for="chk_team" class="inp_func"><spring:message code="label.menu.team"/></label>
									&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="checkbox" id="chk_user" name="chk_user" <c:if test="${menu.chk_user}">checked</c:if>>
									<label for="chk_user" class="inp_func"><spring:message code="label.menu.user"/></label>
								</td>
							</tr>
						</tbody>
					</table>
