...
<%-- <%@page import="com.ncomz.nshop.utility.SessionUtil"%> --%>
<%-- <%@page import="com.ncomz.nshop.utility.StringUtil"%> --%>
<!DOCTYPE html>
...
<script type="text/javascript" src="/js/datapicker/bootstrap-datepicker.ko.js"></script>     <!--datepicker 사용시 필수 // core  -->
...
<script type="text/javascript" src="/js/nms_common.js"></script>
...
<script type="text/javascript" src="/js/chart/excanvas.js"></script>

<!-- 웹페이지 프린트 하기를 위한 JS 추가 -->
